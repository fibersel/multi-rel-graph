...
public class SQLParsingTest {
  ...
  public void loadModel() {
    try {
      final String folder = "/Users/a.palagashvili/coursework/trasnform-tests/resources/SQL";
      ...
      for (final File file : filelist) {
        {
          ...
          if ((result != null)) {
            ...
            EList<select> _statements = result.getStatements();
            for (final select s : _statements) {
      ...
      for (final File file : files) {
        {
          ...
          if (_isDirectory) {
            ...
            boolean _endsWith = fileName.endsWith(".sql");
            if (_endsWith) {
              filelist.add(file);
            }
          }
