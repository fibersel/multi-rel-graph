 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.s2c.cypher.impl.LegacyParameterImpl#getNodeLabels <em>Node Labels</em>}</li>
 *   <li>{@link org.xtext.example.s2c.cypher.impl.LegacyParameterImpl#getPropertyLookups <em>Property Lookups</em>}</li>
 *   <li>{@link org.xtext.example.s2c.cypher.impl.LegacyParameterImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LegacyParameterImpl extends PropertiesImpl implements LegacyParameter
{
  ...
  {
    return CypherPackage.Literals.LEGACY_PARAMETER;
  }
  ...
  public EList<NodeLabel> getNodeLabels()
  {
    if (nodeLabels == null)
    {
      nodeLabels = new EObjectContainmentEList<NodeLabel>(NodeLabel.class, this, CypherPackage.LEGACY_PARAMETER__NODE_LABELS);
    }
    return nodeLabels;
  }
  ...
  public EList<PropertyLookup> getPropertyLookups()
  {
    ...
    {
      propertyLookups = new EObjectContainmentEList<PropertyLookup>(PropertyLookup.class, this, CypherPackage.LEGACY_PARAMETER__PROPERTY_LOOKUPS);
    }
  ...
  public void setParameter(String newParameter)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.LEGACY_PARAMETER__PARAMETER, oldParameter, parameter));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CypherPackage.LEGACY_PARAMETER__NODE_LABELS:
        return ((InternalEList<?>)getNodeLabels()).basicRemove(otherEnd, msgs);
      case CypherPackage.LEGACY_PARAMETER__PROPERTY_LOOKUPS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case CypherPackage.LEGACY_PARAMETER__PARAMETER:
        return getParameter();
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == NodeLabels.class)
    {
      ...
      {
        case CypherPackage.LEGACY_PARAMETER__NODE_LABELS: return CypherPackage.NODE_LABELS__NODE_LABELS;
        default: return -1;
      }
    }
    ...
    if (baseClass == Expression.class)
    {
      switch (derivedFeatureID)
      {
        case CypherPackage.LEGACY_PARAMETER__PROPERTY_LOOKUPS: return CypherPackage.EXPRESSION__PROPERTY_LOOKUPS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == NodeLabels.class)
    {
      ...
      {
        case CypherPackage.NODE_LABELS__NODE_LABELS: return CypherPackage.LEGACY_PARAMETER__NODE_LABELS;
        default: return -1;
      }
    }
    if (baseClass == PropertyExpression.class)
    ...
    if (baseClass == Expression.class)
    {
      switch (baseFeatureID)
      {
        case CypherPackage.EXPRESSION__PROPERTY_LOOKUPS: return CypherPackage.LEGACY_PARAMETER__PROPERTY_LOOKUPS;
        default: return -1;
      }
    }
