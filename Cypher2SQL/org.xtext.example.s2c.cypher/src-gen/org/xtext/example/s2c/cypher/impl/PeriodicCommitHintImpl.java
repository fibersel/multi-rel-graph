 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.s2c.cypher.impl.PeriodicCommitHintImpl#getNumberOfRowsPerCommit <em>Number Of Rows Per Commit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PeriodicCommitHintImpl extends MinimalEObjectImpl.Container implements PeriodicCommitHint
{
  ...
  {
    return CypherPackage.Literals.PERIODIC_COMMIT_HINT;
  }
  ...
  public NotificationChain basicSetNumberOfRowsPerCommit(DecimalInteger newNumberOfRowsPerCommit, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CypherPackage.PERIODIC_COMMIT_HINT__NUMBER_OF_ROWS_PER_COMMIT, oldNumberOfRowsPerCommit, newNumberOfRowsPerCommit);
  ...
  public void setNumberOfRowsPerCommit(DecimalInteger newNumberOfRowsPerCommit)
  {
    if (newNumberOfRowsPerCommit != numberOfRowsPerCommit)
    {
      ...
      if (numberOfRowsPerCommit != null)
        msgs = ((InternalEObject)numberOfRowsPerCommit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CypherPackage.PERIODIC_COMMIT_HINT__NUMBER_OF_ROWS_PER_COMMIT, null, msgs);
      if (newNumberOfRowsPerCommit != null)
        msgs = ((InternalEObject)newNumberOfRowsPerCommit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CypherPackage.PERIODIC_COMMIT_HINT__NUMBER_OF_ROWS_PER_COMMIT, null, msgs);
      msgs = basicSetNumberOfRowsPerCommit(newNumberOfRowsPerCommit, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.PERIODIC_COMMIT_HINT__NUMBER_OF_ROWS_PER_COMMIT, newNumberOfRowsPerCommit, newNumberOfRowsPerCommit));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CypherPackage.PERIODIC_COMMIT_HINT__NUMBER_OF_ROWS_PER_COMMIT:
