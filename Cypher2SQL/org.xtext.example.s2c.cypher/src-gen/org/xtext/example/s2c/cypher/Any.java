 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.s2c.cypher.Any#getFilterExpression <em>Filter Expression</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.s2c.cypher.CypherPackage#getAny()
 * @model
 * @generated
 */
public interface Any extends Expression
{
   ...
   * @see org.xtext.example.s2c.cypher.CypherPackage#getAny_FilterExpression()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.s2c.cypher.Any#getFilterExpression <em>Filter Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
