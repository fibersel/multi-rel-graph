 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.s2c.cypher.impl.OrderImpl#getOrderBy <em>Order By</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrderImpl extends MinimalEObjectImpl.Container implements Order
{
  ...
  {
    return CypherPackage.Literals.ORDER;
  }
  ...
  public EList<SortItem> getOrderBy()
  {
    if (orderBy == null)
    {
      orderBy = new EObjectContainmentEList<SortItem>(SortItem.class, this, CypherPackage.ORDER__ORDER_BY);
    }
    return orderBy;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CypherPackage.ORDER__ORDER_BY:
