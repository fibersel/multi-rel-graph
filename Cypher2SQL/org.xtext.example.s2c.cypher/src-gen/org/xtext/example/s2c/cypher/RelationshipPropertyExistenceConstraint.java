 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.s2c.cypher.RelationshipPropertyExistenceConstraint#getRelationshipPattern <em>Relationship Pattern</em>}</li>
 *   <li>{@link org.xtext.example.s2c.cypher.RelationshipPropertyExistenceConstraint#getPropertyExpression <em>Property Expression</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.s2c.cypher.CypherPackage#getRelationshipPropertyExistenceConstraint()
 * @model
 * @generated
 */
public interface RelationshipPropertyExistenceConstraint extends CreateRelationshipPropertyExistenceConstraint
{
   ...
   * @see org.xtext.example.s2c.cypher.CypherPackage#getRelationshipPropertyExistenceConstraint_RelationshipPattern()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.s2c.cypher.RelationshipPropertyExistenceConstraint#getRelationshipPattern <em>Relationship Pattern</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.s2c.cypher.CypherPackage#getRelationshipPropertyExistenceConstraint_PropertyExpression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.s2c.cypher.RelationshipPropertyExistenceConstraint#getPropertyExpression <em>Property Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
