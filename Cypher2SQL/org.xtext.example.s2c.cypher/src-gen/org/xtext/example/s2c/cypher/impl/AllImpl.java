 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.s2c.cypher.impl.AllImpl#getFilterExpression <em>Filter Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllImpl extends ExpressionImpl implements All
{
  ...
  {
    return CypherPackage.Literals.ALL;
  }
  ...
  public NotificationChain basicSetFilterExpression(FilterExpression newFilterExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CypherPackage.ALL__FILTER_EXPRESSION, oldFilterExpression, newFilterExpression);
  ...
  public void setFilterExpression(FilterExpression newFilterExpression)
  {
    if (newFilterExpression != filterExpression)
    {
      ...
      if (filterExpression != null)
        msgs = ((InternalEObject)filterExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CypherPackage.ALL__FILTER_EXPRESSION, null, msgs);
      if (newFilterExpression != null)
        msgs = ((InternalEObject)newFilterExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CypherPackage.ALL__FILTER_EXPRESSION, null, msgs);
      msgs = basicSetFilterExpression(newFilterExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.ALL__FILTER_EXPRESSION, newFilterExpression, newFilterExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CypherPackage.ALL__FILTER_EXPRESSION:
