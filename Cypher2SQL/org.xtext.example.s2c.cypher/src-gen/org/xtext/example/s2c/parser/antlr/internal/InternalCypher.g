...
@after {
	...
	(
			...
			(
				...
				lv_queryOptions_1_0=ruleQueryOptions
				{
					...
					set(
						...
						"queryOptions",
						lv_queryOptions_1_0,
						"org.xtext.example.s2c.Cypher.QueryOptions");
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getCypherAccess().getStatementsStatementParserRuleCall_2_0());
				}
				lv_statements_2_0=ruleStatement
				{
					...
					add(
						...
						"statements",
						lv_statements_2_0,
						"org.xtext.example.s2c.Cypher.Statement");
					afterParserOrEnumRuleCall();
				}
			)
		)*
...
entryRuleQueryOptions returns [EObject current=null]:
								...
								({true}?=>((
									...
									lv_cypherOption_4_0=ruleCypherOption
									{
										...
										add(
											...
											"cypherOption",
											lv_cypherOption_4_0,
											"org.xtext.example.s2c.Cypher.CypherOption");
										afterParserOrEnumRuleCall();
									}
								)
								))+
			...
			(
				...
				lv_versionNumber_2_0=ruleVersionNumber
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.VersionNumber");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_configurationOption_3_0=ruleConfigurationOption
				{
					...
					add(
						...
						"org.xtext.example.s2c.Cypher.ConfigurationOption");
					afterParserOrEnumRuleCall();
				}
			)
		)*
		...
		(
			...
			lv_versionNumber_0_0=ruleNumber
			{
				...
				set(
					...
					"org.xtext.example.s2c.Cypher.Number");
				afterParserOrEnumRuleCall();
			}
		)
	)
			...
			(
				...
				lv_key_0_0=ruleSYMBOLIC_NAME_X
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"org.xtext.example.s2c.Cypher.SYMBOLIC_NAME_X");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_union_2_0=ruleUnion
					{
						...
						add(
							...
							"union",
							lv_union_2_0,
							"org.xtext.example.s2c.Cypher.Union");
						afterParserOrEnumRuleCall();
					}
				)
			)+
			...
			(
				...
				lv_periodicCommitHint_0_0=rulePeriodicCommitHint
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.PeriodicCommitHint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_loadCSVQuery_1_0=ruleLoadCSVQuery
				{
					...
					set(
						...
						"loadCSVQuery",
						lv_loadCSVQuery_1_0,
						"org.xtext.example.s2c.Cypher.LoadCSVQuery");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_numberOfRowsPerCommit_4_0=ruleDecimalInteger
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.DecimalInteger");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_loadCSV_0_0=ruleLoadCSV
				{
					...
					set(
						...
						"loadCSV",
						lv_loadCSV_0_0,
						"org.xtext.example.s2c.Cypher.LoadCSV");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_singleQuery_1_0=ruleSingleQuery
				{
					...
					set(
						...
						"singleQuery",
						lv_singleQuery_1_0,
						"org.xtext.example.s2c.Cypher.SingleQuery");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_readingClauses_0_0=ruleReadingClause
					{
						...
						add(
							...
							"org.xtext.example.s2c.Cypher.ReadingClause");
						afterParserOrEnumRuleCall();
					}
				)
			)*
				...
				(
					...
					lv_return_1_0=ruleReturn
					{
						...
						set(
							...
							"return",
							lv_return_1_0,
							"org.xtext.example.s2c.Cypher.Return");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_updatingClauses_3_0=ruleUpdatingClause
					{
						...
						add(
							...
							"org.xtext.example.s2c.Cypher.UpdatingClause");
						afterParserOrEnumRuleCall();
					}
				)
			)+
			...
			(
				...
				lv_subQueries_0_0=ruleMultiPartSubQuery
				{
					...
					add(
						...
						"subQueries",
						lv_subQueries_0_0,
						"org.xtext.example.s2c.Cypher.MultiPartSubQuery");
					afterParserOrEnumRuleCall();
				}
			)
		)+
			...
			(
				...
				lv_singlePartQuery_1_0=ruleSinglePartQuery
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.SinglePartQuery");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_withPart_2_0=ruleWith
				{
					...
					set(
						...
						"withPart",
						lv_withPart_2_0,
						"org.xtext.example.s2c.Cypher.With");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_index_1_0=ruleIndex
				{
					...
					set(
						...
						"index",
						lv_index_1_0,
						"org.xtext.example.s2c.Cypher.Index");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_uniqueConstraint_1_0=ruleUniqueConstraint
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.UniqueConstraint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_nodePropertyExistenceConstraint_1_0=ruleNodePropertyExistenceConstraint
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.NodePropertyExistenceConstraint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_relationshipPropertyExistenceConstraint_1_0=ruleRelationshipPropertyExistenceConstraint
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.RelationshipPropertyExistenceConstraint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_nodeLabel_2_0=ruleNodeLabel
				{
					...
					set(
						...
						"nodeLabel",
						lv_nodeLabel_2_0,
						"org.xtext.example.s2c.Cypher.NodeLabel");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_propertyKeyName_4_0=rulePropertyKeyName
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.PropertyKeyName");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_variable_3_0=ruleVariableDeclaration
				{
					...
					set(
						...
						"variable",
						lv_variable_3_0,
						"org.xtext.example.s2c.Cypher.VariableDeclaration");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_propertyExpression_7_0=rulePropertyExpression
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.PropertyExpression");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_relationshipPattern_2_0=ruleRelationshipPatternSyntax
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.RelationshipPatternSyntax");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_incoming_2_0=ruleLeftArrowHead
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.LeftArrowHead");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_relType_6_0=ruleRelType
				{
					...
					set(
						...
						"relType",
						lv_relType_6_0,
						"org.xtext.example.s2c.Cypher.RelType");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_outgoing_9_0=ruleRightArrowHead
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.RightArrowHead");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_withHeaders_3_0=ruleLoadCSVWithHeaders
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.LoadCSVWithHeaders");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_expression_5_0=ruleExpression
				{
					...
					set(
						...
						"expression",
						lv_expression_5_0,
						"org.xtext.example.s2c.Cypher.Expression");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"org.xtext.example.s2c.Cypher.STRING_LITERAL");
					}
				)
			)
		)?
			...
			(
				...
				lv_pattern_2_0=rulePattern
				{
					...
					set(
						...
						"pattern",
						lv_pattern_2_0,
						"org.xtext.example.s2c.Cypher.Pattern");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_hints_3_0=ruleHint
				{
					...
					add(
						...
						"hints",
						lv_hints_3_0,
						"org.xtext.example.s2c.Cypher.Hint");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_where_4_0=ruleWhere
				{
					...
					set(
						...
						"where",
						lv_where_4_0,
						"org.xtext.example.s2c.Cypher.Where");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_patternPart_1_0=rulePatternPart
				{
					...
					set(
						...
						"patternPart",
						lv_patternPart_1_0,
						"org.xtext.example.s2c.Cypher.PatternPart");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_mergeActions_2_0=ruleMergeAction
				{
					...
					add(
						...
						"mergeActions",
						lv_mergeActions_2_0,
						"org.xtext.example.s2c.Cypher.MergeAction");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_set_2_0=ruleSet
				{
					...
					set(
						...
						"set",
						lv_set_2_0,
						"org.xtext.example.s2c.Cypher.Set");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_setItems_1_0=ruleSetItem
				{
					...
					add(
						...
						"setItems",
						lv_setItems_1_0,
						"org.xtext.example.s2c.Cypher.SetItem");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_removeItems_1_0=ruleRemoveItem
				{
					...
					add(
						...
						"removeItems",
						lv_removeItems_1_0,
						"org.xtext.example.s2c.Cypher.RemoveItem");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_invocation_1_0=ruleExplicitProcedureInvocation
				{
					...
					set(
						...
						"invocation",
						lv_invocation_1_0,
						"org.xtext.example.s2c.Cypher.ExplicitProcedureInvocation");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_yieldItems_3_0=ruleYieldItems
					{
						...
						set(
							...
							"yieldItems",
							lv_yieldItems_3_0,
							"org.xtext.example.s2c.Cypher.YieldItems");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_invocation_1_2=ruleImplicitProcedureInvocation
					{
						...
						set(
							...
							"invocation",
							lv_invocation_1_2,
							"org.xtext.example.s2c.Cypher.ImplicitProcedureInvocation");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_items_1_0=ruleYieldItem
						{
							...
							add(
								...
								"items",
								lv_items_1_0,
								"org.xtext.example.s2c.Cypher.YieldItem");
							afterParserOrEnumRuleCall();
						}
					)
				)
				...
				(
					...
					lv_field_0_0=ruleProcedureResultField
					{
						...
						set(
							...
							"field",
							lv_field_0_0,
							"org.xtext.example.s2c.Cypher.ProcedureResultField");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_returnBody_1_0=ruleReturnBody
				{
					...
					set(
						...
						"returnBody",
						lv_returnBody_1_0,
						"org.xtext.example.s2c.Cypher.ReturnBody");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_returnItems_1_0=ruleReturnItems
				{
					...
					set(
						...
						"returnItems",
						lv_returnItems_1_0,
						"org.xtext.example.s2c.Cypher.ReturnItems");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_order_2_0=ruleOrder
				{
					...
					set(
						...
						"order",
						lv_order_2_0,
						"org.xtext.example.s2c.Cypher.Order");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_skip_3_0=ruleSkip
				{
					...
					set(
						...
						"skip",
						lv_skip_3_0,
						"org.xtext.example.s2c.Cypher.Skip");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_limit_4_0=ruleLimit
				{
					...
					set(
						...
						"limit",
						lv_limit_4_0,
						"org.xtext.example.s2c.Cypher.Limit");
					afterParserOrEnumRuleCall();
				}
			)
		)?
						...
						(
							...
							lv_items_3_0=ruleReturnItem
							{
								...
								add(
									...
									"items",
									lv_items_3_0,
									"org.xtext.example.s2c.Cypher.ReturnItem");
								afterParserOrEnumRuleCall();
							}
						)
					)
			...
			(
				...
				lv_orderBy_2_0=ruleSortItem
				{
					...
					add(
						...
						"orderBy",
						lv_orderBy_2_0,
						"org.xtext.example.s2c.Cypher.SortItem");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_startPoint_1_0=ruleStartPoint
				{
					...
					add(
						...
						"startPoint",
						lv_startPoint_1_0,
						"org.xtext.example.s2c.Cypher.StartPoint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_lookup_2_0=ruleLookup
				{
					...
					set(
						...
						"lookup",
						lv_lookup_2_0,
						"org.xtext.example.s2c.Cypher.Lookup");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_legacyParameter_6_0=ruleLegacyParameter
					{
						...
						set(
							...
							"org.xtext.example.s2c.Cypher.LegacyParameter");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_parameter_4_0=ruleParameter
					{
						...
						set(
							...
							"parameter",
							lv_parameter_4_0,
							"org.xtext.example.s2c.Cypher.Parameter");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_ids_1_0=ruleLiteralIds
					{
						...
						set(
							...
							"ids",
							lv_ids_1_0,
							"org.xtext.example.s2c.Cypher.LiteralIds");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_part_2_0=ruleAnonymousPatternPart
					{
						...
						set(
							...
							"part",
							lv_part_2_0,
							"org.xtext.example.s2c.Cypher.AnonymousPatternPart");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_patternElement_3_0=rulePatternElement
					{
						...
						set(
							...
							"org.xtext.example.s2c.Cypher.PatternElement");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_nodepattern_0_0=ruleNodePattern
					{
						...
						set(
							...
							"nodepattern",
							lv_nodepattern_0_0,
							"org.xtext.example.s2c.Cypher.NodePattern");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_chain_1_0=rulePatternElementChain
					{
						...
						add(
							...
							"chain",
							lv_chain_1_0,
							"org.xtext.example.s2c.Cypher.PatternElementChain");
						afterParserOrEnumRuleCall();
					}
				)
			)*
			...
			(
				...
				lv_properties_4_0=ruleProperties
				{
					...
					set(
						...
						"properties",
						lv_properties_4_0,
						"org.xtext.example.s2c.Cypher.Properties");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_relationshipPattern_0_0=ruleRelationshipPattern
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.RelationshipPattern");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_detail_3_0=ruleRelationshipDetail
					{
						...
						set(
							...
							"detail",
							lv_detail_3_0,
							"org.xtext.example.s2c.Cypher.RelationshipDetail");
						afterParserOrEnumRuleCall();
					}
				)
			)?
			...
			(
				...
				lv_range_5_0=ruleRangeLiteral
				{
					...
					set(
						...
						"range",
						lv_range_5_0,
						"org.xtext.example.s2c.Cypher.RangeLiteral");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_relTypeNames_1_0=ruleRelTypeName
				{
					...
					add(
						...
						"relTypeNames",
						lv_relTypeNames_1_0,
						"org.xtext.example.s2c.Cypher.RelTypeName");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_labelName_1_0=ruleLabelName
				{
					...
					set(
						...
						"labelName",
						lv_labelName_1_0,
						"org.xtext.example.s2c.Cypher.LabelName");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_right_3_0=ruleXorExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.s2c.Cypher.XorExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleAndExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.s2c.Cypher.AndExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleNotExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.s2c.Cypher.NotExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleAddOrSubtractExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.s2c.Cypher.AddOrSubtractExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleMultiplyDivideModuloExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.s2c.Cypher.MultiplyDivideModuloExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=rulePowerOfExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.s2c.Cypher.PowerOfExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleUnaryAddOrSubtractExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.s2c.Cypher.UnaryAddOrSubtractExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_expressions_2_1=ruleStringOperatorExpression
						{
							...
							add(
								...
								"expressions",
								lv_expressions_2_1,
								"org.xtext.example.s2c.Cypher.StringOperatorExpression");
							afterParserOrEnumRuleCall();
						}
						    |
						{
						...
						lv_expressions_2_2=ruleListOperatorExpression
						{
							...
							add(
								...
								"expressions",
								lv_expressions_2_2,
								"org.xtext.example.s2c.Cypher.ListOperatorExpression");
							afterParserOrEnumRuleCall();
						}
						    |
						{
						...
						lv_expressions_2_3=ruleNullOperatorExpression
						{
							...
							add(
								...
								"expressions",
								lv_expressions_2_3,
								"org.xtext.example.s2c.Cypher.NullOperatorExpression");
							afterParserOrEnumRuleCall();
						}
					)
				)
			...
			(
				...
				lv_right_12_0=rulePropertyOrLabelsExpression
				{
					...
					set(
						...
						"right",
						lv_right_12_0,
						"org.xtext.example.s2c.Cypher.PropertyOrLabelsExpression");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_propertyLookups_2_0=rulePropertyLookup
					{
						...
						add(
							...
							"org.xtext.example.s2c.Cypher.PropertyLookup");
						afterParserOrEnumRuleCall();
					}
				)
			)+
				...
				(
					...
					lv_filterExpression_14_0=ruleFilterExpression
					{
						...
						set(
							...
							"org.xtext.example.s2c.Cypher.FilterExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_idInColl_6_0=ruleIdInColl
				{
					...
					set(
						...
						"idInColl",
						lv_idInColl_6_0,
						"org.xtext.example.s2c.Cypher.IdInColl");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_functionName_0_0=ruleFunctionName
				{
					...
					set(
						...
						"functionName",
						lv_functionName_0_0,
						"org.xtext.example.s2c.Cypher.FunctionName");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_procedureName_0_0=ruleProcedureName
				{
					...
					set(
						...
						"org.xtext.example.s2c.Cypher.ProcedureName");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_namespace_0_0=ruleNamespace
				{
					...
					set(
						...
						"namespace",
						lv_namespace_0_0,
						"org.xtext.example.s2c.Cypher.Namespace");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_pattern_3_0=ruleRelationshipsPattern
				{
					...
					set(
						...
						"pattern",
						lv_pattern_3_0,
						"org.xtext.example.s2c.Cypher.RelationshipsPattern");
					afterParserOrEnumRuleCall();
				}
			)
		)
					...
					(
						...
						lv_caseAlternatives_1_0=ruleCaseAlternatives
						{
							...
							add(
								...
								"org.xtext.example.s2c.Cypher.CaseAlternatives");
							afterParserOrEnumRuleCall();
						}
					)
				)+
				...
				(
					...
					lv_entries_2_0=ruleMapLiteralEntry
					{
						...
						add(
							...
							"entries",
							lv_entries_2_0,
							"org.xtext.example.s2c.Cypher.MapLiteralEntry");
						afterParserOrEnumRuleCall();
					}
				)
			)
