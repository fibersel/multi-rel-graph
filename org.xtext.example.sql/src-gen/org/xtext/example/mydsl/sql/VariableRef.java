 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.sql.VariableRef#getVariableRef <em>Variable Ref</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.sql.SqlPackage#getVariableRef()
 * @model
 * @generated
 */
public interface VariableRef extends Expression
{
   ...
   * @see org.xtext.example.mydsl.sql.SqlPackage#getVariableRef_VariableRef()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.sql.VariableRef#getVariableRef <em>Variable Ref</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
