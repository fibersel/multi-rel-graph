 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.IndexHintImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.IndexHintImpl#getNodeLabel <em>Node Label</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.IndexHintImpl#getPropertyKeyName <em>Property Key Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexHintImpl extends HintImpl implements IndexHint
{
  ...
  {
    return MyDslPackage.Literals.INDEX_HINT;
  }
  ...
  public NotificationChain basicSetVariable(VariableDeclaration newVariable, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.INDEX_HINT__VARIABLE, oldVariable, newVariable);
  ...
  public void setVariable(VariableDeclaration newVariable)
  {
    if (newVariable != variable)
    {
      ...
      if (variable != null)
        msgs = ((InternalEObject)variable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INDEX_HINT__VARIABLE, null, msgs);
      if (newVariable != null)
        msgs = ((InternalEObject)newVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INDEX_HINT__VARIABLE, null, msgs);
      msgs = basicSetVariable(newVariable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INDEX_HINT__VARIABLE, newVariable, newVariable));
  }
  ...
  public NotificationChain basicSetNodeLabel(NodeLabel newNodeLabel, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.INDEX_HINT__NODE_LABEL, oldNodeLabel, newNodeLabel);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setNodeLabel(NodeLabel newNodeLabel)
  {
    if (newNodeLabel != nodeLabel)
    {
      NotificationChain msgs = null;
      if (nodeLabel != null)
        msgs = ((InternalEObject)nodeLabel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INDEX_HINT__NODE_LABEL, null, msgs);
      if (newNodeLabel != null)
        msgs = ((InternalEObject)newNodeLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INDEX_HINT__NODE_LABEL, null, msgs);
      msgs = basicSetNodeLabel(newNodeLabel, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INDEX_HINT__NODE_LABEL, newNodeLabel, newNodeLabel));
  }
  ...
  public void setPropertyKeyName(String newPropertyKeyName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INDEX_HINT__PROPERTY_KEY_NAME, oldPropertyKeyName, propertyKeyName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.INDEX_HINT__VARIABLE:
        return basicSetVariable(null, msgs);
      case MyDslPackage.INDEX_HINT__NODE_LABEL:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.INDEX_HINT__NODE_LABEL:
        return getNodeLabel();
      case MyDslPackage.INDEX_HINT__PROPERTY_KEY_NAME:
