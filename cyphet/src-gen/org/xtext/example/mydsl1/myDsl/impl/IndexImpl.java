 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.IndexImpl#getNodeLabel <em>Node Label</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.IndexImpl#getPropertyKeyName <em>Property Key Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexImpl extends MinimalEObjectImpl.Container implements Index
{
  ...
  public NotificationChain basicSetNodeLabel(NodeLabel newNodeLabel, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.INDEX__NODE_LABEL, oldNodeLabel, newNodeLabel);
  ...
  public void setNodeLabel(NodeLabel newNodeLabel)
  {
    if (newNodeLabel != nodeLabel)
    {
      ...
      if (nodeLabel != null)
        msgs = ((InternalEObject)nodeLabel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INDEX__NODE_LABEL, null, msgs);
      if (newNodeLabel != null)
        msgs = ((InternalEObject)newNodeLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INDEX__NODE_LABEL, null, msgs);
      msgs = basicSetNodeLabel(newNodeLabel, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INDEX__NODE_LABEL, newNodeLabel, newNodeLabel));
  }
  ...
  public void setPropertyKeyName(String newPropertyKeyName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INDEX__PROPERTY_KEY_NAME, oldPropertyKeyName, propertyKeyName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.INDEX__NODE_LABEL:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.INDEX__NODE_LABEL:
        return getNodeLabel();
      case MyDslPackage.INDEX__PROPERTY_KEY_NAME:
