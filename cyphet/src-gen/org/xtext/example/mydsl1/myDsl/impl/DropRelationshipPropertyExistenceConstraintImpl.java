 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.DropRelationshipPropertyExistenceConstraintImpl#getRelationshipPropertyExistenceConstraint <em>Relationship Property Existence Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DropRelationshipPropertyExistenceConstraintImpl extends CommandImpl implements DropRelationshipPropertyExistenceConstraint
{
  ...
  {
    return MyDslPackage.Literals.DROP_RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT;
  }
  ...
  public NotificationChain basicSetRelationshipPropertyExistenceConstraint(RelationshipPropertyExistenceConstraint newRelationshipPropertyExistenceConstraint, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.DROP_RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT, oldRelationshipPropertyExistenceConstraint, newRelationshipPropertyExistenceConstraint);
  ...
  public void setRelationshipPropertyExistenceConstraint(RelationshipPropertyExistenceConstraint newRelationshipPropertyExistenceConstraint)
  {
    if (newRelationshipPropertyExistenceConstraint != relationshipPropertyExistenceConstraint)
    {
      ...
      if (relationshipPropertyExistenceConstraint != null)
        msgs = ((InternalEObject)relationshipPropertyExistenceConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.DROP_RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT, null, msgs);
      if (newRelationshipPropertyExistenceConstraint != null)
        msgs = ((InternalEObject)newRelationshipPropertyExistenceConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.DROP_RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT, null, msgs);
      msgs = basicSetRelationshipPropertyExistenceConstraint(newRelationshipPropertyExistenceConstraint, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.DROP_RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT, newRelationshipPropertyExistenceConstraint, newRelationshipPropertyExistenceConstraint));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.DROP_RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT:
