 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.ParameterImpl#getNodeLabels <em>Node Labels</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.ParameterImpl#getPropertyLookups <em>Property Lookups</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.ParameterImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends PropertiesImpl implements Parameter
{
  ...
  public EList<NodeLabel> getNodeLabels()
  {
    if (nodeLabels == null)
    {
      nodeLabels = new EObjectContainmentEList<NodeLabel>(NodeLabel.class, this, MyDslPackage.PARAMETER__NODE_LABELS);
    }
    return nodeLabels;
  }
  ...
  public EList<PropertyLookup> getPropertyLookups()
  {
    ...
    {
      propertyLookups = new EObjectContainmentEList<PropertyLookup>(PropertyLookup.class, this, MyDslPackage.PARAMETER__PROPERTY_LOOKUPS);
    }
  ...
  public void setParameter(String newParameter)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.PARAMETER__PARAMETER, oldParameter, parameter));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.PARAMETER__NODE_LABELS:
        return ((InternalEList<?>)getNodeLabels()).basicRemove(otherEnd, msgs);
      case MyDslPackage.PARAMETER__PROPERTY_LOOKUPS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.PARAMETER__PARAMETER:
        return getParameter();
    }
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == NodeLabels.class)
    {
      ...
      {
        case MyDslPackage.PARAMETER__NODE_LABELS: return MyDslPackage.NODE_LABELS__NODE_LABELS;
        default: return -1;
      }
    }
    ...
    if (baseClass == Expression.class)
    {
      switch (derivedFeatureID)
      {
        case MyDslPackage.PARAMETER__PROPERTY_LOOKUPS: return MyDslPackage.EXPRESSION__PROPERTY_LOOKUPS;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == NodeLabels.class)
    {
      ...
      {
        case MyDslPackage.NODE_LABELS__NODE_LABELS: return MyDslPackage.PARAMETER__NODE_LABELS;
        default: return -1;
      }
    }
    if (baseClass == PropertyExpression.class)
    ...
    if (baseClass == Expression.class)
    {
      switch (baseFeatureID)
      {
        case MyDslPackage.EXPRESSION__PROPERTY_LOOKUPS: return MyDslPackage.PARAMETER__PROPERTY_LOOKUPS;
        default: return -1;
      }
    }
