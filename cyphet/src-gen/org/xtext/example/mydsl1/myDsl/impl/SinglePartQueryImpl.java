 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.SinglePartQueryImpl#getReadingClauses <em>Reading Clauses</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.SinglePartQueryImpl#getReturn <em>Return</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.SinglePartQueryImpl#getUpdatingClauses <em>Updating Clauses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SinglePartQueryImpl extends SingleQueryImpl implements SinglePartQuery
{
  ...
  {
    return MyDslPackage.Literals.SINGLE_PART_QUERY;
  }
  ...
  public EList<ReadingClause> getReadingClauses()
  {
    ...
    {
      readingClauses = new EObjectContainmentEList<ReadingClause>(ReadingClause.class, this, MyDslPackage.SINGLE_PART_QUERY__READING_CLAUSES);
    }
  ...
  public NotificationChain basicSetReturn(Return newReturn, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.SINGLE_PART_QUERY__RETURN, oldReturn, newReturn);
  ...
  public void setReturn(Return newReturn)
  {
    if (newReturn != return_)
    {
      ...
      if (return_ != null)
        msgs = ((InternalEObject)return_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SINGLE_PART_QUERY__RETURN, null, msgs);
      if (newReturn != null)
        msgs = ((InternalEObject)newReturn).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.SINGLE_PART_QUERY__RETURN, null, msgs);
      msgs = basicSetReturn(newReturn, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.SINGLE_PART_QUERY__RETURN, newReturn, newReturn));
  }
  ...
  public EList<UpdatingClause> getUpdatingClauses()
  {
    ...
    {
      updatingClauses = new EObjectContainmentEList<UpdatingClause>(UpdatingClause.class, this, MyDslPackage.SINGLE_PART_QUERY__UPDATING_CLAUSES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.SINGLE_PART_QUERY__READING_CLAUSES:
        return ((InternalEList<?>)getReadingClauses()).basicRemove(otherEnd, msgs);
      case MyDslPackage.SINGLE_PART_QUERY__RETURN:
        return basicSetReturn(null, msgs);
      case MyDslPackage.SINGLE_PART_QUERY__UPDATING_CLAUSES:
