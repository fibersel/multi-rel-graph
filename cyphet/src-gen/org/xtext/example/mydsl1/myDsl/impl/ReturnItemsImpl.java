 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.ReturnItemsImpl#getAll <em>All</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.ReturnItemsImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReturnItemsImpl extends MinimalEObjectImpl.Container implements ReturnItems
{
  ...
  {
    return MyDslPackage.Literals.RETURN_ITEMS;
  }
  ...
  public void setAll(String newAll)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RETURN_ITEMS__ALL, oldAll, all));
  }
  ...
  public EList<ReturnItem> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<ReturnItem>(ReturnItem.class, this, MyDslPackage.RETURN_ITEMS__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.RETURN_ITEMS__ITEMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.RETURN_ITEMS__ALL:
        return getAll();
      case MyDslPackage.RETURN_ITEMS__ITEMS:
        return getItems();
    }
