 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.BulkImportQueryImpl#getPeriodicCommitHint <em>Periodic Commit Hint</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.BulkImportQueryImpl#getLoadCSVQuery <em>Load CSV Query</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BulkImportQueryImpl extends QueryImpl implements BulkImportQuery
{
  ...
  {
    return MyDslPackage.Literals.BULK_IMPORT_QUERY;
  }
  ...
  public NotificationChain basicSetPeriodicCommitHint(PeriodicCommitHint newPeriodicCommitHint, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.BULK_IMPORT_QUERY__PERIODIC_COMMIT_HINT, oldPeriodicCommitHint, newPeriodicCommitHint);
  ...
  public void setPeriodicCommitHint(PeriodicCommitHint newPeriodicCommitHint)
  {
    if (newPeriodicCommitHint != periodicCommitHint)
    {
      ...
      if (periodicCommitHint != null)
        msgs = ((InternalEObject)periodicCommitHint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.BULK_IMPORT_QUERY__PERIODIC_COMMIT_HINT, null, msgs);
      if (newPeriodicCommitHint != null)
        msgs = ((InternalEObject)newPeriodicCommitHint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.BULK_IMPORT_QUERY__PERIODIC_COMMIT_HINT, null, msgs);
      msgs = basicSetPeriodicCommitHint(newPeriodicCommitHint, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.BULK_IMPORT_QUERY__PERIODIC_COMMIT_HINT, newPeriodicCommitHint, newPeriodicCommitHint));
  }
  ...
  public NotificationChain basicSetLoadCSVQuery(LoadCSVQuery newLoadCSVQuery, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.BULK_IMPORT_QUERY__LOAD_CSV_QUERY, oldLoadCSVQuery, newLoadCSVQuery);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLoadCSVQuery(LoadCSVQuery newLoadCSVQuery)
  {
    if (newLoadCSVQuery != loadCSVQuery)
    {
      ...
      if (loadCSVQuery != null)
        msgs = ((InternalEObject)loadCSVQuery).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.BULK_IMPORT_QUERY__LOAD_CSV_QUERY, null, msgs);
      if (newLoadCSVQuery != null)
        msgs = ((InternalEObject)newLoadCSVQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.BULK_IMPORT_QUERY__LOAD_CSV_QUERY, null, msgs);
      msgs = basicSetLoadCSVQuery(newLoadCSVQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.BULK_IMPORT_QUERY__LOAD_CSV_QUERY, newLoadCSVQuery, newLoadCSVQuery));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.BULK_IMPORT_QUERY__PERIODIC_COMMIT_HINT:
        return basicSetPeriodicCommitHint(null, msgs);
      case MyDslPackage.BULK_IMPORT_QUERY__LOAD_CSV_QUERY:
