...
import org.xtext.example.mydsl1.myDsl.Parameter;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.IdLookupImpl#getIds <em>Ids</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.IdLookupImpl#getLegacyParameter <em>Legacy Parameter</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.IdLookupImpl#getWildcard <em>Wildcard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IdLookupImpl extends NodeLookupImpl implements IdLookup
{
  ...
  {
    return MyDslPackage.Literals.ID_LOOKUP;
  }
  ...
  public NotificationChain basicSetIds(LiteralIds newIds, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ID_LOOKUP__IDS, oldIds, newIds);
  ...
  public void setIds(LiteralIds newIds)
  {
    if (newIds != ids)
    {
      ...
      if (ids != null)
        msgs = ((InternalEObject)ids).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ID_LOOKUP__IDS, null, msgs);
      if (newIds != null)
        msgs = ((InternalEObject)newIds).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ID_LOOKUP__IDS, null, msgs);
      msgs = basicSetIds(newIds, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ID_LOOKUP__IDS, newIds, newIds));
  }
  ...
  public NotificationChain basicSetLegacyParameter(Parameter newLegacyParameter, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ID_LOOKUP__LEGACY_PARAMETER, oldLegacyParameter, newLegacyParameter);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLegacyParameter(Parameter newLegacyParameter)
  {
    if (newLegacyParameter != legacyParameter)
    {
      ...
      if (legacyParameter != null)
        msgs = ((InternalEObject)legacyParameter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ID_LOOKUP__LEGACY_PARAMETER, null, msgs);
      if (newLegacyParameter != null)
        msgs = ((InternalEObject)newLegacyParameter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ID_LOOKUP__LEGACY_PARAMETER, null, msgs);
      msgs = basicSetLegacyParameter(newLegacyParameter, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ID_LOOKUP__LEGACY_PARAMETER, newLegacyParameter, newLegacyParameter));
  }
  ...
  public void setWildcard(String newWildcard)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ID_LOOKUP__WILDCARD, oldWildcard, wildcard));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.ID_LOOKUP__IDS:
        return basicSetIds(null, msgs);
      case MyDslPackage.ID_LOOKUP__LEGACY_PARAMETER:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.ID_LOOKUP__WILDCARD:
        return getWildcard();
    }
