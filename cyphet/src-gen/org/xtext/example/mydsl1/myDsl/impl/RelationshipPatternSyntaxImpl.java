 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.RelationshipPatternSyntaxImpl#isIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.RelationshipPatternSyntaxImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.RelationshipPatternSyntaxImpl#getRelType <em>Rel Type</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.RelationshipPatternSyntaxImpl#isOutgoing <em>Outgoing</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipPatternSyntaxImpl extends MinimalEObjectImpl.Container implements RelationshipPatternSyntax
{
  ...
  {
    return MyDslPackage.Literals.RELATIONSHIP_PATTERN_SYNTAX;
  }
  ...
  public void setIncoming(boolean newIncoming)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__INCOMING, oldIncoming, incoming));
  }
  ...
  public NotificationChain basicSetVariable(VariableDeclaration newVariable, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__VARIABLE, oldVariable, newVariable);
  ...
  public void setVariable(VariableDeclaration newVariable)
  {
    if (newVariable != variable)
    {
      ...
      if (variable != null)
        msgs = ((InternalEObject)variable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__VARIABLE, null, msgs);
      if (newVariable != null)
        msgs = ((InternalEObject)newVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__VARIABLE, null, msgs);
      msgs = basicSetVariable(newVariable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__VARIABLE, newVariable, newVariable));
  }
  ...
  public void setRelType(String newRelType)
  {
    ...
    relType = newRelType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__REL_TYPE, oldRelType, relType));
  }
  ...
  public void setOutgoing(boolean newOutgoing)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__OUTGOING, oldOutgoing, outgoing));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__VARIABLE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__INCOMING:
        return isIncoming();
      case MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__VARIABLE:
        return getVariable();
      case MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__REL_TYPE:
        return getRelType();
      case MyDslPackage.RELATIONSHIP_PATTERN_SYNTAX__OUTGOING:
        return isOutgoing();
    }
