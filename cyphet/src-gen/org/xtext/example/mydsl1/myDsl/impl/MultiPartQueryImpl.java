 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.MultiPartQueryImpl#getSubQueries <em>Sub Queries</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.MultiPartQueryImpl#getSinglePartQuery <em>Single Part Query</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiPartQueryImpl extends SingleQueryImpl implements MultiPartQuery
{
  ...
  {
    return MyDslPackage.Literals.MULTI_PART_QUERY;
  }
  ...
  public EList<MultiPartSubQuery> getSubQueries()
  {
    if (subQueries == null)
    {
      subQueries = new EObjectContainmentEList<MultiPartSubQuery>(MultiPartSubQuery.class, this, MyDslPackage.MULTI_PART_QUERY__SUB_QUERIES);
    }
    return subQueries;
  }
  ...
  public NotificationChain basicSetSinglePartQuery(SinglePartQuery newSinglePartQuery, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.MULTI_PART_QUERY__SINGLE_PART_QUERY, oldSinglePartQuery, newSinglePartQuery);
  ...
  public void setSinglePartQuery(SinglePartQuery newSinglePartQuery)
  {
    if (newSinglePartQuery != singlePartQuery)
    {
      ...
      if (singlePartQuery != null)
        msgs = ((InternalEObject)singlePartQuery).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MULTI_PART_QUERY__SINGLE_PART_QUERY, null, msgs);
      if (newSinglePartQuery != null)
        msgs = ((InternalEObject)newSinglePartQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MULTI_PART_QUERY__SINGLE_PART_QUERY, null, msgs);
      msgs = basicSetSinglePartQuery(newSinglePartQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.MULTI_PART_QUERY__SINGLE_PART_QUERY, newSinglePartQuery, newSinglePartQuery));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.MULTI_PART_QUERY__SUB_QUERIES:
        return ((InternalEList<?>)getSubQueries()).basicRemove(otherEnd, msgs);
      case MyDslPackage.MULTI_PART_QUERY__SINGLE_PART_QUERY:
