 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.LiteralIdsImpl#getIds <em>Ids</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralIdsImpl extends MinimalEObjectImpl.Container implements LiteralIds
{
  ...
  {
    return MyDslPackage.Literals.LITERAL_IDS;
  }
  ...
  public EList<DecimalInteger> getIds()
  {
    if (ids == null)
    {
      ids = new EObjectContainmentEList<DecimalInteger>(DecimalInteger.class, this, MyDslPackage.LITERAL_IDS__IDS);
    }
    return ids;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.LITERAL_IDS__IDS:
