 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.CaseExpressionImpl#getCaseAlternatives <em>Case Alternatives</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.CaseExpressionImpl#getCaseExpression <em>Case Expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.CaseExpressionImpl#getElseExpression <em>Else Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CaseExpressionImpl extends ExpressionImpl implements CaseExpression
{
  ...
  {
    return MyDslPackage.Literals.CASE_EXPRESSION;
  }
  ...
  public EList<CaseAlternatives> getCaseAlternatives()
  {
    ...
    {
      caseAlternatives = new EObjectContainmentEList<CaseAlternatives>(CaseAlternatives.class, this, MyDslPackage.CASE_EXPRESSION__CASE_ALTERNATIVES);
    }
  ...
  public NotificationChain basicSetCaseExpression(Expression newCaseExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.CASE_EXPRESSION__CASE_EXPRESSION, oldCaseExpression, newCaseExpression);
  ...
  public void setCaseExpression(Expression newCaseExpression)
  {
    if (newCaseExpression != caseExpression)
    {
      ...
      if (caseExpression != null)
        msgs = ((InternalEObject)caseExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.CASE_EXPRESSION__CASE_EXPRESSION, null, msgs);
      if (newCaseExpression != null)
        msgs = ((InternalEObject)newCaseExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.CASE_EXPRESSION__CASE_EXPRESSION, null, msgs);
      msgs = basicSetCaseExpression(newCaseExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.CASE_EXPRESSION__CASE_EXPRESSION, newCaseExpression, newCaseExpression));
  }
  ...
  public NotificationChain basicSetElseExpression(Expression newElseExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.CASE_EXPRESSION__ELSE_EXPRESSION, oldElseExpression, newElseExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setElseExpression(Expression newElseExpression)
  {
    if (newElseExpression != elseExpression)
    {
      ...
      if (elseExpression != null)
        msgs = ((InternalEObject)elseExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.CASE_EXPRESSION__ELSE_EXPRESSION, null, msgs);
      if (newElseExpression != null)
        msgs = ((InternalEObject)newElseExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.CASE_EXPRESSION__ELSE_EXPRESSION, null, msgs);
      msgs = basicSetElseExpression(newElseExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.CASE_EXPRESSION__ELSE_EXPRESSION, newElseExpression, newElseExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.CASE_EXPRESSION__CASE_ALTERNATIVES:
        return ((InternalEList<?>)getCaseAlternatives()).basicRemove(otherEnd, msgs);
      case MyDslPackage.CASE_EXPRESSION__CASE_EXPRESSION:
        return basicSetCaseExpression(null, msgs);
      case MyDslPackage.CASE_EXPRESSION__ELSE_EXPRESSION:
