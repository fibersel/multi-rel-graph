 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.YieldItemsImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class YieldItemsImpl extends MinimalEObjectImpl.Container implements YieldItems
{
  ...
  {
    return MyDslPackage.Literals.YIELD_ITEMS;
  }
  ...
  public EList<YieldItem> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<YieldItem>(YieldItem.class, this, MyDslPackage.YIELD_ITEMS__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.YIELD_ITEMS__ITEMS:
