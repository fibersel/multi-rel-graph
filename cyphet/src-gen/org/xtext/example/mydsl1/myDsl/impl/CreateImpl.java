 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.CreateImpl#isUniqueContraint <em>Unique Contraint</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.CreateImpl#getPattern <em>Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CreateImpl extends UpdatingClauseImpl implements Create
{
  ...
  public void setUniqueContraint(boolean newUniqueContraint)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.CREATE__UNIQUE_CONTRAINT, oldUniqueContraint, uniqueContraint));
  }
  ...
  public NotificationChain basicSetPattern(Pattern newPattern, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.CREATE__PATTERN, oldPattern, newPattern);
  ...
  public void setPattern(Pattern newPattern)
  {
    if (newPattern != pattern)
    {
      ...
      if (pattern != null)
        msgs = ((InternalEObject)pattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.CREATE__PATTERN, null, msgs);
      if (newPattern != null)
        msgs = ((InternalEObject)newPattern).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.CREATE__PATTERN, null, msgs);
      msgs = basicSetPattern(newPattern, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.CREATE__PATTERN, newPattern, newPattern));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.CREATE__PATTERN:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.CREATE__UNIQUE_CONTRAINT:
