 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.LoadCSVQueryImpl#getLoadCSV <em>Load CSV</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.LoadCSVQueryImpl#getSingleQuery <em>Single Query</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoadCSVQueryImpl extends MinimalEObjectImpl.Container implements LoadCSVQuery
{
  ...
  {
    return MyDslPackage.Literals.LOAD_CSV_QUERY;
  }
  ...
  public NotificationChain basicSetLoadCSV(LoadCSV newLoadCSV, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV_QUERY__LOAD_CSV, oldLoadCSV, newLoadCSV);
  ...
  public void setLoadCSV(LoadCSV newLoadCSV)
  {
    if (newLoadCSV != loadCSV)
    {
      ...
      if (loadCSV != null)
        msgs = ((InternalEObject)loadCSV).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOAD_CSV_QUERY__LOAD_CSV, null, msgs);
      if (newLoadCSV != null)
        msgs = ((InternalEObject)newLoadCSV).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOAD_CSV_QUERY__LOAD_CSV, null, msgs);
      msgs = basicSetLoadCSV(newLoadCSV, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV_QUERY__LOAD_CSV, newLoadCSV, newLoadCSV));
  }
  ...
  public NotificationChain basicSetSingleQuery(SingleQuery newSingleQuery, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV_QUERY__SINGLE_QUERY, oldSingleQuery, newSingleQuery);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setSingleQuery(SingleQuery newSingleQuery)
  {
    if (newSingleQuery != singleQuery)
    {
      NotificationChain msgs = null;
      if (singleQuery != null)
        msgs = ((InternalEObject)singleQuery).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOAD_CSV_QUERY__SINGLE_QUERY, null, msgs);
      if (newSingleQuery != null)
        msgs = ((InternalEObject)newSingleQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOAD_CSV_QUERY__SINGLE_QUERY, null, msgs);
      msgs = basicSetSingleQuery(newSingleQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV_QUERY__SINGLE_QUERY, newSingleQuery, newSingleQuery));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.LOAD_CSV_QUERY__LOAD_CSV:
        return basicSetLoadCSV(null, msgs);
      case MyDslPackage.LOAD_CSV_QUERY__SINGLE_QUERY:
