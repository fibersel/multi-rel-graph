 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.LoadCSVImpl#isWithHeaders <em>With Headers</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.LoadCSVImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.LoadCSVImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.LoadCSVImpl#getFieldterminator <em>Fieldterminator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LoadCSVImpl extends ReadingClauseImpl implements LoadCSV
{
  ...
  {
    return MyDslPackage.Literals.LOAD_CSV;
  }
  ...
  public void setWithHeaders(boolean newWithHeaders)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV__WITH_HEADERS, oldWithHeaders, withHeaders));
  }
  ...
  public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV__EXPRESSION, oldExpression, newExpression);
  ...
  public void setExpression(Expression newExpression)
  {
    if (newExpression != expression)
    {
      ...
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOAD_CSV__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOAD_CSV__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV__EXPRESSION, newExpression, newExpression));
  }
  ...
  public NotificationChain basicSetVariable(VariableDeclaration newVariable, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV__VARIABLE, oldVariable, newVariable);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setVariable(VariableDeclaration newVariable)
  {
    if (newVariable != variable)
    {
      NotificationChain msgs = null;
      if (variable != null)
        msgs = ((InternalEObject)variable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOAD_CSV__VARIABLE, null, msgs);
      if (newVariable != null)
        msgs = ((InternalEObject)newVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOAD_CSV__VARIABLE, null, msgs);
      msgs = basicSetVariable(newVariable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV__VARIABLE, newVariable, newVariable));
  }
  ...
  public void setFieldterminator(String newFieldterminator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.LOAD_CSV__FIELDTERMINATOR, oldFieldterminator, fieldterminator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.LOAD_CSV__EXPRESSION:
        return basicSetExpression(null, msgs);
      case MyDslPackage.LOAD_CSV__VARIABLE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.LOAD_CSV__WITH_HEADERS:
        return isWithHeaders();
      case MyDslPackage.LOAD_CSV__EXPRESSION:
        return getExpression();
      case MyDslPackage.LOAD_CSV__VARIABLE:
        return getVariable();
      case MyDslPackage.LOAD_CSV__FIELDTERMINATOR:
