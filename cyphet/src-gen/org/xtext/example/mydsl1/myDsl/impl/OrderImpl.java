 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.OrderImpl#getOrderBy <em>Order By</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrderImpl extends MinimalEObjectImpl.Container implements Order
{
  ...
  {
    return MyDslPackage.Literals.ORDER;
  }
  ...
  public EList<SortItem> getOrderBy()
  {
    if (orderBy == null)
    {
      orderBy = new EObjectContainmentEList<SortItem>(SortItem.class, this, MyDslPackage.ORDER__ORDER_BY);
    }
    return orderBy;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.ORDER__ORDER_BY:
