 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.RelationshipPropertyExistenceConstraintImpl#getRelationshipPattern <em>Relationship Pattern</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.RelationshipPropertyExistenceConstraintImpl#getPropertyExpression <em>Property Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipPropertyExistenceConstraintImpl extends CreateRelationshipPropertyExistenceConstraintImpl implements RelationshipPropertyExistenceConstraint
{
  ...
  {
    return MyDslPackage.Literals.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT;
  }
  ...
  public NotificationChain basicSetRelationshipPattern(RelationshipPatternSyntax newRelationshipPattern, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PATTERN, oldRelationshipPattern, newRelationshipPattern);
  ...
  public void setRelationshipPattern(RelationshipPatternSyntax newRelationshipPattern)
  {
    if (newRelationshipPattern != relationshipPattern)
    {
      ...
      if (relationshipPattern != null)
        msgs = ((InternalEObject)relationshipPattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PATTERN, null, msgs);
      if (newRelationshipPattern != null)
        msgs = ((InternalEObject)newRelationshipPattern).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PATTERN, null, msgs);
      msgs = basicSetRelationshipPattern(newRelationshipPattern, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PATTERN, newRelationshipPattern, newRelationshipPattern));
  }
  ...
  public NotificationChain basicSetPropertyExpression(PropertyExpression newPropertyExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__PROPERTY_EXPRESSION, oldPropertyExpression, newPropertyExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setPropertyExpression(PropertyExpression newPropertyExpression)
  {
    if (newPropertyExpression != propertyExpression)
    {
      ...
      if (propertyExpression != null)
        msgs = ((InternalEObject)propertyExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__PROPERTY_EXPRESSION, null, msgs);
      if (newPropertyExpression != null)
        msgs = ((InternalEObject)newPropertyExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__PROPERTY_EXPRESSION, null, msgs);
      msgs = basicSetPropertyExpression(newPropertyExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__PROPERTY_EXPRESSION, newPropertyExpression, newPropertyExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__RELATIONSHIP_PATTERN:
        return basicSetRelationshipPattern(null, msgs);
      case MyDslPackage.RELATIONSHIP_PROPERTY_EXISTENCE_CONSTRAINT__PROPERTY_EXPRESSION:
