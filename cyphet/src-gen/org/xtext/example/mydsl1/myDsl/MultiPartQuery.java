 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.MultiPartQuery#getSubQueries <em>Sub Queries</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.MultiPartQuery#getSinglePartQuery <em>Single Part Query</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl1.myDsl.MyDslPackage#getMultiPartQuery()
 * @model
 * @generated
 */
public interface MultiPartQuery extends SingleQuery
{
   ...
   * The list contents are of type {@link org.xtext.example.mydsl1.myDsl.MultiPartSubQuery}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Sub Queries</em>' containment reference list.
   * @see org.xtext.example.mydsl1.myDsl.MyDslPackage#getMultiPartQuery_SubQueries()
   ...
   * @see org.xtext.example.mydsl1.myDsl.MyDslPackage#getMultiPartQuery_SinglePartQuery()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl1.myDsl.MultiPartQuery#getSinglePartQuery <em>Single Part Query</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
