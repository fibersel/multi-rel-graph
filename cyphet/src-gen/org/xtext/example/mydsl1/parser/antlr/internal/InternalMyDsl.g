			...
			(
				...
				lv_queryOptions_1_0=ruleQueryOptions
				{
					...
					set(
						...
						"queryOptions",
						lv_queryOptions_1_0,
						"org.xtext.example.mydsl1.MyDsl.QueryOptions");
								...
								({true}?=>((
									...
									lv_cypherOption_4_0=ruleCypherOption
									{
										...
										add(
											...
											"cypherOption",
											lv_cypherOption_4_0,
											"org.xtext.example.mydsl1.MyDsl.CypherOption");
										afterParserOrEnumRuleCall();
									}
								)
								))+
			...
			(
				...
				lv_versionNumber_2_0=ruleVersionNumber
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.VersionNumber");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_configurationOption_3_0=ruleConfigurationOption
				{
					...
					add(
						...
						"org.xtext.example.mydsl1.MyDsl.ConfigurationOption");
					afterParserOrEnumRuleCall();
				}
			)
		)*
		...
		(
			...
			lv_versionNumber_0_0=ruleNumber
			{
				...
				set(
					...
					"org.xtext.example.mydsl1.MyDsl.Number");
				afterParserOrEnumRuleCall();
			}
		)
	)
			...
			(
				...
				lv_key_0_0=ruleSYMBOLIC_NAME_X
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"org.xtext.example.mydsl1.MyDsl.SYMBOLIC_NAME_X");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_union_2_0=ruleUnion
					{
						...
						add(
							...
							"union",
							lv_union_2_0,
							"org.xtext.example.mydsl1.MyDsl.Union");
						afterParserOrEnumRuleCall();
					}
				)
			)+
			...
			(
				...
				lv_periodicCommitHint_0_0=rulePeriodicCommitHint
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.PeriodicCommitHint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_loadCSVQuery_1_0=ruleLoadCSVQuery
				{
					...
					set(
						...
						"loadCSVQuery",
						lv_loadCSVQuery_1_0,
						"org.xtext.example.mydsl1.MyDsl.LoadCSVQuery");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_numberOfRowsPerCommit_4_0=ruleDecimalInteger
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.DecimalInteger");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_loadCSV_0_0=ruleLoadCSV
				{
					...
					set(
						...
						"loadCSV",
						lv_loadCSV_0_0,
						"org.xtext.example.mydsl1.MyDsl.LoadCSV");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_singleQuery_1_0=ruleSingleQuery
				{
					...
					set(
						...
						"singleQuery",
						lv_singleQuery_1_0,
						"org.xtext.example.mydsl1.MyDsl.SingleQuery");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_readingClauses_0_0=ruleReadingClause
					{
						...
						add(
							...
							"org.xtext.example.mydsl1.MyDsl.ReadingClause");
						afterParserOrEnumRuleCall();
					}
				)
			)*
				...
				(
					...
					lv_return_1_0=ruleReturn
					{
						...
						set(
							...
							"return",
							lv_return_1_0,
							"org.xtext.example.mydsl1.MyDsl.Return");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_updatingClauses_3_0=ruleUpdatingClause
					{
						...
						add(
							...
							"org.xtext.example.mydsl1.MyDsl.UpdatingClause");
						afterParserOrEnumRuleCall();
					}
				)
			)+
			...
			(
				...
				lv_subQueries_0_0=ruleMultiPartSubQuery
				{
					...
					add(
						...
						"subQueries",
						lv_subQueries_0_0,
						"org.xtext.example.mydsl1.MyDsl.MultiPartSubQuery");
					afterParserOrEnumRuleCall();
				}
			)
		)+
			...
			(
				...
				lv_singlePartQuery_1_0=ruleSinglePartQuery
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.SinglePartQuery");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_withPart_2_0=ruleWith
				{
					...
					set(
						...
						"withPart",
						lv_withPart_2_0,
						"org.xtext.example.mydsl1.MyDsl.With");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_index_1_0=ruleIndex
				{
					...
					set(
						...
						"index",
						lv_index_1_0,
						"org.xtext.example.mydsl1.MyDsl.Index");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_uniqueConstraint_1_0=ruleUniqueConstraint
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.UniqueConstraint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_nodePropertyExistenceConstraint_1_0=ruleNodePropertyExistenceConstraint
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.NodePropertyExistenceConstraint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_relationshipPropertyExistenceConstraint_1_0=ruleRelationshipPropertyExistenceConstraint
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.RelationshipPropertyExistenceConstraint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_nodeLabel_2_0=ruleNodeLabel
				{
					...
					set(
						...
						"nodeLabel",
						lv_nodeLabel_2_0,
						"org.xtext.example.mydsl1.MyDsl.NodeLabel");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_propertyKeyName_4_0=rulePropertyKeyName
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.PropertyKeyName");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_propertyExpression_7_0=rulePropertyExpression
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.PropertyExpression");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_relationshipPattern_2_0=ruleRelationshipPatternSyntax
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.RelationshipPatternSyntax");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_incoming_2_0=ruleLeftArrowHead
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.LeftArrowHead");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_relType_6_0=ruleRelType
				{
					...
					set(
						...
						"relType",
						lv_relType_6_0,
						"org.xtext.example.mydsl1.MyDsl.RelType");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_outgoing_9_0=ruleRightArrowHead
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.RightArrowHead");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_withHeaders_3_0=ruleLoadCSVWithHeaders
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.LoadCSVWithHeaders");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"org.xtext.example.mydsl1.MyDsl.STRING_LITERAL");
					}
				)
			)
		)?
			...
			(
				...
				lv_pattern_2_0=rulePattern
				{
					...
					set(
						...
						"pattern",
						lv_pattern_2_0,
						"org.xtext.example.mydsl1.MyDsl.Pattern");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_hints_3_0=ruleHint
				{
					...
					add(
						...
						"hints",
						lv_hints_3_0,
						"org.xtext.example.mydsl1.MyDsl.Hint");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_where_4_0=ruleWhere
				{
					...
					set(
						...
						"where",
						lv_where_4_0,
						"org.xtext.example.mydsl1.MyDsl.Where");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_patternPart_1_0=rulePatternPart
				{
					...
					set(
						...
						"patternPart",
						lv_patternPart_1_0,
						"org.xtext.example.mydsl1.MyDsl.PatternPart");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_mergeActions_2_0=ruleMergeAction
				{
					...
					add(
						...
						"mergeActions",
						lv_mergeActions_2_0,
						"org.xtext.example.mydsl1.MyDsl.MergeAction");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_set_2_0=ruleSet
				{
					...
					set(
						...
						"set",
						lv_set_2_0,
						"org.xtext.example.mydsl1.MyDsl.Set");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_setItems_1_0=ruleSetItem
				{
					...
					add(
						...
						"setItems",
						lv_setItems_1_0,
						"org.xtext.example.mydsl1.MyDsl.SetItem");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_removeItems_1_0=ruleRemoveItem
				{
					...
					add(
						...
						"removeItems",
						lv_removeItems_1_0,
						"org.xtext.example.mydsl1.MyDsl.RemoveItem");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_invocation_1_0=ruleExplicitProcedureInvocation
				{
					...
					set(
						...
						"invocation",
						lv_invocation_1_0,
						"org.xtext.example.mydsl1.MyDsl.ExplicitProcedureInvocation");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_yieldItems_3_0=ruleYieldItems
					{
						...
						set(
							...
							"yieldItems",
							lv_yieldItems_3_0,
							"org.xtext.example.mydsl1.MyDsl.YieldItems");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_invocation_1_2=ruleImplicitProcedureInvocation
					{
						...
						set(
							...
							"invocation",
							lv_invocation_1_2,
							"org.xtext.example.mydsl1.MyDsl.ImplicitProcedureInvocation");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_items_1_0=ruleYieldItem
						{
							...
							add(
								...
								"items",
								lv_items_1_0,
								"org.xtext.example.mydsl1.MyDsl.YieldItem");
							afterParserOrEnumRuleCall();
						}
					)
				)
				...
				(
					...
					lv_field_0_0=ruleProcedureResultField
					{
						...
						set(
							...
							"field",
							lv_field_0_0,
							"org.xtext.example.mydsl1.MyDsl.ProcedureResultField");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_returnBody_1_0=ruleReturnBody
				{
					...
					set(
						...
						"returnBody",
						lv_returnBody_1_0,
						"org.xtext.example.mydsl1.MyDsl.ReturnBody");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_returnItems_1_0=ruleReturnItems
				{
					...
					set(
						...
						"returnItems",
						lv_returnItems_1_0,
						"org.xtext.example.mydsl1.MyDsl.ReturnItems");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_order_2_0=ruleOrder
				{
					...
					set(
						...
						"order",
						lv_order_2_0,
						"org.xtext.example.mydsl1.MyDsl.Order");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_skip_3_0=ruleSkip
				{
					...
					set(
						...
						"skip",
						lv_skip_3_0,
						"org.xtext.example.mydsl1.MyDsl.Skip");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_limit_4_0=ruleLimit
				{
					...
					set(
						...
						"limit",
						lv_limit_4_0,
						"org.xtext.example.mydsl1.MyDsl.Limit");
					afterParserOrEnumRuleCall();
				}
			)
		)?
						...
						(
							...
							lv_items_3_0=ruleReturnItem
							{
								...
								add(
									...
									"items",
									lv_items_3_0,
									"org.xtext.example.mydsl1.MyDsl.ReturnItem");
								afterParserOrEnumRuleCall();
							}
						)
					)
			...
			(
				...
				lv_orderBy_2_0=ruleSortItem
				{
					...
					add(
						...
						"orderBy",
						lv_orderBy_2_0,
						"org.xtext.example.mydsl1.MyDsl.SortItem");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_startPoint_1_0=ruleStartPoint
				{
					...
					add(
						...
						"startPoint",
						lv_startPoint_1_0,
						"org.xtext.example.mydsl1.MyDsl.StartPoint");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_lookup_2_0=ruleLookup
				{
					...
					set(
						...
						"lookup",
						lv_lookup_2_0,
						"org.xtext.example.mydsl1.MyDsl.Lookup");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_legacyParameter_6_0=ruleLegacyParameter
					{
						...
						set(
							...
							"org.xtext.example.mydsl1.MyDsl.LegacyParameter");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_ids_1_0=ruleLiteralIds
					{
						...
						set(
							...
							"ids",
							lv_ids_1_0,
							"org.xtext.example.mydsl1.MyDsl.LiteralIds");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_part_2_0=ruleAnonymousPatternPart
					{
						...
						set(
							...
							"part",
							lv_part_2_0,
							"org.xtext.example.mydsl1.MyDsl.AnonymousPatternPart");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_patternElement_3_0=rulePatternElement
					{
						...
						set(
							...
							"org.xtext.example.mydsl1.MyDsl.PatternElement");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_nodepattern_0_0=ruleNodePattern
					{
						...
						set(
							...
							"nodepattern",
							lv_nodepattern_0_0,
							"org.xtext.example.mydsl1.MyDsl.NodePattern");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_chain_1_0=rulePatternElementChain
					{
						...
						add(
							...
							"chain",
							lv_chain_1_0,
							"org.xtext.example.mydsl1.MyDsl.PatternElementChain");
						afterParserOrEnumRuleCall();
					}
				)
			)*
			...
			(
				...
				lv_properties_4_0=ruleProperties
				{
					...
					set(
						...
						"properties",
						lv_properties_4_0,
						"org.xtext.example.mydsl1.MyDsl.Properties");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_relationshipPattern_0_0=ruleRelationshipPattern
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.RelationshipPattern");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_detail_3_0=ruleRelationshipDetail
					{
						...
						set(
							...
							"detail",
							lv_detail_3_0,
							"org.xtext.example.mydsl1.MyDsl.RelationshipDetail");
						afterParserOrEnumRuleCall();
					}
				)
			)?
			...
			(
				...
				lv_range_5_0=ruleRangeLiteral
				{
					...
					set(
						...
						"range",
						lv_range_5_0,
						"org.xtext.example.mydsl1.MyDsl.RangeLiteral");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_relTypeNames_1_0=ruleRelTypeName
				{
					...
					add(
						...
						"relTypeNames",
						lv_relTypeNames_1_0,
						"org.xtext.example.mydsl1.MyDsl.RelTypeName");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_labelName_1_0=ruleLabelName
				{
					...
					set(
						...
						"labelName",
						lv_labelName_1_0,
						"org.xtext.example.mydsl1.MyDsl.LabelName");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_right_3_0=ruleXorExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.mydsl1.MyDsl.XorExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleNotExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.mydsl1.MyDsl.NotExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleAddOrSubtractExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.mydsl1.MyDsl.AddOrSubtractExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleMultiplyDivideModuloExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.mydsl1.MyDsl.MultiplyDivideModuloExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=rulePowerOfExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.mydsl1.MyDsl.PowerOfExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleUnaryAddOrSubtractExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.example.mydsl1.MyDsl.UnaryAddOrSubtractExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_expressions_2_1=ruleStringOperatorExpression
						{
							...
							add(
								...
								"expressions",
								lv_expressions_2_1,
								"org.xtext.example.mydsl1.MyDsl.StringOperatorExpression");
							afterParserOrEnumRuleCall();
						}
						    |
						{
						...
						lv_expressions_2_2=ruleListOperatorExpression
						{
							...
							add(
								...
								"expressions",
								lv_expressions_2_2,
								"org.xtext.example.mydsl1.MyDsl.ListOperatorExpression");
							afterParserOrEnumRuleCall();
						}
						    |
						{
						...
						lv_expressions_2_3=ruleNullOperatorExpression
						{
							...
							add(
								...
								"expressions",
								lv_expressions_2_3,
								"org.xtext.example.mydsl1.MyDsl.NullOperatorExpression");
							afterParserOrEnumRuleCall();
						}
					)
				)
			...
			(
				...
				lv_right_12_0=rulePropertyOrLabelsExpression
				{
					...
					set(
						...
						"right",
						lv_right_12_0,
						"org.xtext.example.mydsl1.MyDsl.PropertyOrLabelsExpression");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_propertyLookups_2_0=rulePropertyLookup
					{
						...
						add(
							...
							"org.xtext.example.mydsl1.MyDsl.PropertyLookup");
						afterParserOrEnumRuleCall();
					}
				)
			)+
				...
				(
					...
					lv_filterExpression_14_0=ruleFilterExpression
					{
						...
						set(
							...
							"org.xtext.example.mydsl1.MyDsl.FilterExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_idInColl_6_0=ruleIdInColl
				{
					...
					set(
						...
						"idInColl",
						lv_idInColl_6_0,
						"org.xtext.example.mydsl1.MyDsl.IdInColl");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_functionName_0_0=ruleFunctionName
				{
					...
					set(
						...
						"functionName",
						lv_functionName_0_0,
						"org.xtext.example.mydsl1.MyDsl.FunctionName");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_procedureName_0_0=ruleProcedureName
				{
					...
					set(
						...
						"org.xtext.example.mydsl1.MyDsl.ProcedureName");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_namespace_0_0=ruleNamespace
				{
					...
					set(
						...
						"namespace",
						lv_namespace_0_0,
						"org.xtext.example.mydsl1.MyDsl.Namespace");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_pattern_3_0=ruleRelationshipsPattern
				{
					...
					set(
						...
						"pattern",
						lv_pattern_3_0,
						"org.xtext.example.mydsl1.MyDsl.RelationshipsPattern");
					afterParserOrEnumRuleCall();
				}
			)
		)
					...
					(
						...
						lv_caseAlternatives_1_0=ruleCaseAlternatives
						{
							...
							add(
								...
								"org.xtext.example.mydsl1.MyDsl.CaseAlternatives");
							afterParserOrEnumRuleCall();
						}
					)
				)+
				...
				(
					...
					lv_entries_2_0=ruleMapLiteralEntry
					{
						...
						add(
							...
							"entries",
							lv_entries_2_0,
							"org.xtext.example.mydsl1.MyDsl.MapLiteralEntry");
						afterParserOrEnumRuleCall();
					}
				)
			)
