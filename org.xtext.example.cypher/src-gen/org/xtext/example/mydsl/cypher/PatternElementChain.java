 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.PatternElementChain#getRelationshipPattern <em>Relationship Pattern</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.cypher.PatternElementChain#getNodePattern <em>Node Pattern</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.cypher.CypherPackage#getPatternElementChain()
 * @model
 * @generated
 */
public interface PatternElementChain extends EObject
{
   ...
   * @see org.xtext.example.mydsl.cypher.CypherPackage#getPatternElementChain_RelationshipPattern()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.cypher.PatternElementChain#getRelationshipPattern <em>Relationship Pattern</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.cypher.CypherPackage#getPatternElementChain_NodePattern()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.cypher.PatternElementChain#getNodePattern <em>Node Pattern</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
