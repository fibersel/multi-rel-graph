 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.Limit#getLimit <em>Limit</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.cypher.CypherPackage#getLimit()
 * @model
 * @generated
 */
public interface Limit extends EObject
{
   ...
   * @see org.xtext.example.mydsl.cypher.CypherPackage#getLimit_Limit()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.cypher.Limit#getLimit <em>Limit</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
