 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.PatternElement#getNodepattern <em>Nodepattern</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.cypher.PatternElement#getChain <em>Chain</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.cypher.CypherPackage#getPatternElement()
 * @model
 * @generated
 */
public interface PatternElement extends AnonymousPatternPart
{
   ...
   * @see org.xtext.example.mydsl.cypher.CypherPackage#getPatternElement_Nodepattern()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.cypher.PatternElement#getNodepattern <em>Nodepattern</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.cypher.CypherPackage#getPatternElement_Chain()
   * @model containment="true"
   * @generated
   */
