 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.DropNodePropertyExistenceConstraintImpl#getNodePropertyExistenceConstraint <em>Node Property Existence Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DropNodePropertyExistenceConstraintImpl extends CommandImpl implements DropNodePropertyExistenceConstraint
{
  ...
  {
    return CypherPackage.Literals.DROP_NODE_PROPERTY_EXISTENCE_CONSTRAINT;
  }
  ...
  public NotificationChain basicSetNodePropertyExistenceConstraint(NodePropertyExistenceConstraint newNodePropertyExistenceConstraint, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CypherPackage.DROP_NODE_PROPERTY_EXISTENCE_CONSTRAINT__NODE_PROPERTY_EXISTENCE_CONSTRAINT, oldNodePropertyExistenceConstraint, newNodePropertyExistenceConstraint);
  ...
  public void setNodePropertyExistenceConstraint(NodePropertyExistenceConstraint newNodePropertyExistenceConstraint)
  {
    if (newNodePropertyExistenceConstraint != nodePropertyExistenceConstraint)
    {
      ...
      if (nodePropertyExistenceConstraint != null)
        msgs = ((InternalEObject)nodePropertyExistenceConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CypherPackage.DROP_NODE_PROPERTY_EXISTENCE_CONSTRAINT__NODE_PROPERTY_EXISTENCE_CONSTRAINT, null, msgs);
      if (newNodePropertyExistenceConstraint != null)
        msgs = ((InternalEObject)newNodePropertyExistenceConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CypherPackage.DROP_NODE_PROPERTY_EXISTENCE_CONSTRAINT__NODE_PROPERTY_EXISTENCE_CONSTRAINT, null, msgs);
      msgs = basicSetNodePropertyExistenceConstraint(newNodePropertyExistenceConstraint, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.DROP_NODE_PROPERTY_EXISTENCE_CONSTRAINT__NODE_PROPERTY_EXISTENCE_CONSTRAINT, newNodePropertyExistenceConstraint, newNodePropertyExistenceConstraint));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CypherPackage.DROP_NODE_PROPERTY_EXISTENCE_CONSTRAINT__NODE_PROPERTY_EXISTENCE_CONSTRAINT:
