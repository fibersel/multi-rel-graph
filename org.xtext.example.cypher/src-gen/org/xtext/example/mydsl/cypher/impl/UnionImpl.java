 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.UnionImpl#isAll <em>All</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.UnionImpl#getSingleQuery <em>Single Query</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnionImpl extends MinimalEObjectImpl.Container implements Union
{
  ...
  public void setAll(boolean newAll)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.UNION__ALL, oldAll, all));
  }
  ...
  public NotificationChain basicSetSingleQuery(SingleQuery newSingleQuery, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CypherPackage.UNION__SINGLE_QUERY, oldSingleQuery, newSingleQuery);
  ...
  public void setSingleQuery(SingleQuery newSingleQuery)
  {
    if (newSingleQuery != singleQuery)
    {
      ...
      if (singleQuery != null)
        msgs = ((InternalEObject)singleQuery).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CypherPackage.UNION__SINGLE_QUERY, null, msgs);
      if (newSingleQuery != null)
        msgs = ((InternalEObject)newSingleQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CypherPackage.UNION__SINGLE_QUERY, null, msgs);
      msgs = basicSetSingleQuery(newSingleQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.UNION__SINGLE_QUERY, newSingleQuery, newSingleQuery));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CypherPackage.UNION__SINGLE_QUERY:
