 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.CombinedQueryImpl#getSingleQuery <em>Single Query</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.CombinedQueryImpl#getUnion <em>Union</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CombinedQueryImpl extends RegularQueryImpl implements CombinedQuery
{
  ...
  {
    return CypherPackage.Literals.COMBINED_QUERY;
  }
  ...
  public NotificationChain basicSetSingleQuery(SingleQuery newSingleQuery, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CypherPackage.COMBINED_QUERY__SINGLE_QUERY, oldSingleQuery, newSingleQuery);
  ...
  public void setSingleQuery(SingleQuery newSingleQuery)
  {
    if (newSingleQuery != singleQuery)
    {
      ...
      if (singleQuery != null)
        msgs = ((InternalEObject)singleQuery).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CypherPackage.COMBINED_QUERY__SINGLE_QUERY, null, msgs);
      if (newSingleQuery != null)
        msgs = ((InternalEObject)newSingleQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CypherPackage.COMBINED_QUERY__SINGLE_QUERY, null, msgs);
      msgs = basicSetSingleQuery(newSingleQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.COMBINED_QUERY__SINGLE_QUERY, newSingleQuery, newSingleQuery));
  }
  ...
  public EList<Union> getUnion()
  {
    if (union == null)
    {
      union = new EObjectContainmentEList<Union>(Union.class, this, CypherPackage.COMBINED_QUERY__UNION);
    }
    return union;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CypherPackage.COMBINED_QUERY__SINGLE_QUERY:
        return basicSetSingleQuery(null, msgs);
      case CypherPackage.COMBINED_QUERY__UNION:
