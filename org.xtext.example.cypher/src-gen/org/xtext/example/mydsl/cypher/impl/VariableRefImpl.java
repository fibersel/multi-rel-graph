 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.VariableRefImpl#getVariableRef <em>Variable Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableRefImpl extends ExpressionImpl implements VariableRef
{
  ...
  public NotificationChain basicSetVariableRef(VariableDeclaration newVariableRef, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CypherPackage.VARIABLE_REF__VARIABLE_REF, oldVariableRef, newVariableRef);
  ...
  public void setVariableRef(VariableDeclaration newVariableRef)
  {
    if (newVariableRef != variableRef)
    {
      ...
      if (variableRef != null)
        msgs = ((InternalEObject)variableRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CypherPackage.VARIABLE_REF__VARIABLE_REF, null, msgs);
      if (newVariableRef != null)
        msgs = ((InternalEObject)newVariableRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CypherPackage.VARIABLE_REF__VARIABLE_REF, null, msgs);
      msgs = basicSetVariableRef(newVariableRef, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.VARIABLE_REF__VARIABLE_REF, newVariableRef, newVariableRef));
  }
