 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.PatternElementImpl#getNodepattern <em>Nodepattern</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.PatternElementImpl#getChain <em>Chain</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatternElementImpl extends AnonymousPatternPartImpl implements PatternElement
{
  ...
  {
    return CypherPackage.Literals.PATTERN_ELEMENT;
  }
  ...
  public NotificationChain basicSetNodepattern(NodePattern newNodepattern, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CypherPackage.PATTERN_ELEMENT__NODEPATTERN, oldNodepattern, newNodepattern);
  ...
  public void setNodepattern(NodePattern newNodepattern)
  {
    if (newNodepattern != nodepattern)
    {
      ...
      if (nodepattern != null)
        msgs = ((InternalEObject)nodepattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CypherPackage.PATTERN_ELEMENT__NODEPATTERN, null, msgs);
      if (newNodepattern != null)
        msgs = ((InternalEObject)newNodepattern).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CypherPackage.PATTERN_ELEMENT__NODEPATTERN, null, msgs);
      msgs = basicSetNodepattern(newNodepattern, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.PATTERN_ELEMENT__NODEPATTERN, newNodepattern, newNodepattern));
  }
  ...
  public EList<PatternElementChain> getChain()
  {
    if (chain == null)
    {
      chain = new EObjectContainmentEList<PatternElementChain>(PatternElementChain.class, this, CypherPackage.PATTERN_ELEMENT__CHAIN);
    }
    return chain;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CypherPackage.PATTERN_ELEMENT__NODEPATTERN:
        return basicSetNodepattern(null, msgs);
      case CypherPackage.PATTERN_ELEMENT__CHAIN:
