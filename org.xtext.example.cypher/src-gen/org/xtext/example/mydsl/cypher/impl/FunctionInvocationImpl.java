 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.FunctionInvocationImpl#getFunctionName <em>Function Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.FunctionInvocationImpl#isDistinct <em>Distinct</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.cypher.impl.FunctionInvocationImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionInvocationImpl extends ExpressionImpl implements FunctionInvocation
{
  ...
  public void setFunctionName(String newFunctionName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.FUNCTION_INVOCATION__FUNCTION_NAME, oldFunctionName, functionName));
  }
  ...
  public void setDistinct(boolean newDistinct)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CypherPackage.FUNCTION_INVOCATION__DISTINCT, oldDistinct, distinct));
  }
  ...
  public EList<Expression> getParameter()
  {
    if (parameter == null)
    {
      parameter = new EObjectContainmentEList<Expression>(Expression.class, this, CypherPackage.FUNCTION_INVOCATION__PARAMETER);
    }
    return parameter;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CypherPackage.FUNCTION_INVOCATION__PARAMETER:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CypherPackage.FUNCTION_INVOCATION__FUNCTION_NAME:
