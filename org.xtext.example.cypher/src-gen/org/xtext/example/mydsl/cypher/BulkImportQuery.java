 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.cypher.BulkImportQuery#getPeriodicCommitHint <em>Periodic Commit Hint</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.cypher.BulkImportQuery#getLoadCSVQuery <em>Load CSV Query</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.cypher.CypherPackage#getBulkImportQuery()
 * @model
 * @generated
 */
public interface BulkImportQuery extends Query
{
   ...
   * @see org.xtext.example.mydsl.cypher.CypherPackage#getBulkImportQuery_PeriodicCommitHint()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.cypher.BulkImportQuery#getPeriodicCommitHint <em>Periodic Commit Hint</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.cypher.CypherPackage#getBulkImportQuery_LoadCSVQuery()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.cypher.BulkImportQuery#getLoadCSVQuery <em>Load CSV Query</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
