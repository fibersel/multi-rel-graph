...
import org.xtext.example.mydsl.ide.contentassist.antlr.internal.InternalCypherParser;
import org.xtext.example.mydsl.services.CypherGrammarAccess;

public class CypherParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(CypherGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CypherGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCypherAccess().getGroup_2(), "rule__Cypher__Group_2__0");
			...
			builder.put(grammarAccess.getCypherAccess().getStatementsAssignment_2_0(), "rule__Cypher__StatementsAssignment_2_0");
	...
	@Override
	protected InternalCypherParser createParser() {
		InternalCypherParser result = new InternalCypherParser(null);
